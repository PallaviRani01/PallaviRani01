...
Hi, I'm **Pallavi Rani**, a passionate **Data Science student** with a strong foundation in **Machine Learning, Data Visualization, and Full-Stack Web Development**. I love exploring real-world datasets, building predictive models, and creating interactive dashboards that turn raw data into actionable insights.<br><br>I have hands-on experience with **Python, JavaScript, C++**, and tools like **Power BI, Pandas, NumPy, Scikit-Learn, and Matplotlib**. My projects range from analyzing **U.S. Chronic Disease Indicators using ML** to building **interactive COVID-19 dashboards** and **Customer Churn Analysis dashboards** with Power BI.<br><br>Beyond data science, I enjoy building **full-stack web applications** — from a **Medical Web App** and **Personal Finance Tracker** to a **Real-Time Chat Application** using Socket programming. I'm always eager to learn, build, and solve real-world problems through code and data.
...
|---------|-------------|------|
| 🏥 [Medical Web App](https://github.com/PallaviRani01/Medical-1) | Healthcare data management with medical insights | JavaScript |
| 📊 [U.S. Chronic Disease ML Analysis](https://github.com/PallaviRani01/U.S.-Chronic-Disease-Indicators-Analysis-Using-Machine-Learning-Visualization) | ML-powered health data analysis with regression, classification & clustering | Python |
| 📈 [Customer Churn Dashboard](https://github.com/PallaviRani01/Customer-Churn-Analysis-Dashboard-Power-BI-) | Interactive Power BI dashboard for customer churn analysis | Power BI |
| 🦠 [COVID-19 Vaccination Dashboard](https://github.com/PallaviRani01/-Covid-19-Outcome_by_Vaccination_Status-DASHBOARD-) | Dashboard comparing vaccinated vs unvaccinated outcomes | Power BI |
| 💰 [Personal Finance Tracker](https://github.com/PallaviRani01/Personal-Finance-Tracker) | Web app for income, expense & balance tracking | JavaScript |
| 💬 [Real-Time Chat App](https://github.com/PallaviRani01/Chat-App-Simple-real-time-chat-using-sockets) | Real-time messaging using socket programming | JavaScript |
...
![](https://github-contributor-stats.vercel.app/api?username=PallaviRani01&limit=5&theme=radical&combine_all_yearly_contributions=true)
...
<div align="center">
  ...
  [![](https://visitcount.itsvg.in/api?id=PallaviRani01&icon=5&color=11)](https://visitcount.itsvg.in)
...
<!-- Proudly inspired by GPRM ( https://gprm.itsvg.in ) -->
